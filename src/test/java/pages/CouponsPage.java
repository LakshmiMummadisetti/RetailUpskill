...
public class CouponsPage {
	...
	@FindBy (xpath = "//a[@data-original-title='Add New']") WebElement click_add_coupon;
	
	@FindBy (xpath ="//td[contains(text(),'Lakshmi Coupon')]") WebElement verifyTheAddedcoupon;
	@FindBy (xpath="//div/table/tbody/tr//td[contains(text(),'Lakshmi Coupon')]//following-sibling::td[6]/a/i") WebElement editcouponbutton;
	@FindBy (xpath = "//td[contains(text(),'KumariM')]") WebElement editedCouponName;
	@FindBy (xpath = "//td[contains(text(),'KumariM')]//parent::tr//input") WebElement checkbox;
	@FindBy (xpath="//button[@data-original-title='Delete']") WebElement delete;
	public CouponsPage()
	{
