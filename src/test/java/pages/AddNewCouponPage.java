...
public class AddNewCouponPage {
	...
	int max = 11400000;
	 ...
	 @FindBy (id ="input-name") WebElement enterCouponName;
	 @FindBy (name ="code") WebElement enterCode;
	 @FindBy (name = "type") WebElement type;
	 @FindBy (name = "discount") WebElement discount;
	 @FindBy (name = "total") WebElement total;
	 @FindBy (xpath ="//input[@name='logged' and @value='1']") WebElement customer_login_radio;
	 @FindBy (xpath ="//input[@name='shipping' and @value='1']") WebElement freeshipping_radio;
	 @FindBy (name ="product") WebElement productdetails;
	 @FindBy (name ="category") WebElement category;
	 @FindBy (xpath="(//button[@class='btn btn-default'])[1]") WebElement startcalendar;
	 @FindBy(xpath="//td[@class='day active today']") WebElement startdate;
	 @FindBy (xpath = "(//button[@class='btn btn-default'])[2]") WebElement endcalendar;
	 @FindBy (xpath = "//td[@class='day active']") WebElement enddate;
	 @FindBy (name="uses_total") WebElement entertotal;
	 @FindBy (name="uses_customer") WebElement user_per_customer;
	 @FindBy (name="status") WebElement selectStatus;
